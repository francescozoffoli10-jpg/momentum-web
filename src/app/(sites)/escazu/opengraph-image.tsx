...
export const alt = 'Momentum Escazú'
...
export default function Image() {
  return new ImageResponse(
    (
      ...
      >
        {/* Left accent bar */}
        <div style={{ position: 'absolute', top: 0, left: 0, bottom: 0, width: 6, background: '#56717A', display: 'flex' }} />

        {/* Top label */}
        <div style={{ position: 'absolute', top: 60, left: 88, display: 'flex', alignItems: 'center', gap: 14 }}>
          <div style={{ width: 28, height: 1, background: '#56717A', display: 'flex' }} />
          <span style={{ color: '#56717A', fontSize: 13, fontWeight: 700, letterSpacing: 5, textTransform: 'uppercase', fontFamily: 'sans-serif' }}>
            Costa Rica
          </span>
        </div>
        ...
        <div style={{ display: 'flex' }}>
          <span style={{ fontSize: 22, color: 'rgba(255,255,255,0.42)', fontWeight: 300, fontFamily: 'sans-serif' }}>
            Calma · Bienestar · Experiencia Premium · San José, Costa Rica
          </span>
        </div>
      </div>
    ),
