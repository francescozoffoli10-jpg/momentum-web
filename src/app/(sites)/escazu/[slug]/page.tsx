...
export default async function TenantDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const backHref = `/escazu/${tenant.section}`
        ...
        <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 32px' }}>
          <div className="tenant-hero-grid">
            <div className="tenant-hero-logo" style={{ width: 180, height: 180, background: 'rgba(255,255,255,0.03)', border: '0.5px solid rgba(255,255,255,0.08)', borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
              <Image src={`/sites/escazu/logos/${tenant.logo}`} alt={tenant.name} width={140} height={140} style={{ objectFit: 'contain', maxHeight: 120, width: 'auto' }} />
            </div>
            <div>
      ...
      <div className="tenant-body-grid">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
          {tenant.hours.length > 0 && (
            <div style={{ background: 'var(--bg)', border: '0.5px solid var(--brd)', borderRadius: 6, padding: '24px 24px' }}>
          ...
          <div style={{ background: 'var(--bg)', border: '0.5px solid var(--brd)', borderRadius: 6, padding: '24px 24px', display: 'flex', flexDirection: 'column', gap: 14 }}>
